...
##PORJECT TEST SECTION

## PREPROCESSING IMAGE
img = cv2.imread(pathImage) #original img
...
cv2.putText(imgRawGrade,str(int(score))+"%",(90,100),cv2.FONT_HERSHEY_COMPLEX,3,(125,246,55),8)
...
ImgArray = ([img,imgGray,imgBlur,imgCanny],[imgContour,Biggest_contour_Img,img_warp_colored,imgThresh],[result_img,ImgRawDrawing,Inv_img_warp,imgFinal])
